    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                @if (!isset($user))
                    {!! Form::open(array('url' => ['users/save'], 'class' => 'form-horizontal', 'role' => 'form')) !!}
                @else
                    {!! Form::model($user, array('url' => ['users/save'], 'class' => 'form-horizontal', 'role' => 'form')) !!}
                @endif
                        {!! Form::hidden('id') !!}
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($roles as $rol)
                                {!! Form::checkbox('roles[]', $rol->slug)." ".$rol->description !!}<br/>
                            @endforeach
                            </div>
                        </div>
